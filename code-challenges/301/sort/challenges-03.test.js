...
const sortMeetingsByDay = (arr) => {
  let dows = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];
  arr.sort((a, b) => {
    return dows.indexOf(a.dayOfWeek) - dows.indexOf(b.dayOfWeek);
  });
  return arr;
};
...
const sortSchedule = (arr) => {
  let dows = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'];
  arr.sort((a, b) => {
    let aDateTime = dows.indexOf(a.dayOfWeek) + a.start + a.end;
    let bDateTime = dows.indexOf(b.dayOfWeek) + b.start + b.end;
